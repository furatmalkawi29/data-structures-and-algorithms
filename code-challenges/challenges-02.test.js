...
const appendTheEnd = (str) => {
  //string is array of character --> str is array
  let strNew = str.concat(' The end.'); // if we didnt use strNew /worked on str --> original array will change
  return strNew;
};
